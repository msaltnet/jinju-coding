...
이제 버튼을 누르면 버저에서 소리가 나는 프로그램을 작성해보겠습니다. 만들어진 프로그램을 파일로 불러와서 아두이노 IDE에서 아두이노로 업로드 해보세요. [`piano.ino`](https://github.com/msaltnet/jinju-coding/blob/main/code/piano.ino)파일 입니다.
